...
old1 = '''import AsyncStorage from '@react-native-async-storage/async-storage';
'''
new1 = '''import AsyncStorage from '@react-native-async-storage/async-storage';
import { getPartLabel, getIcon, getSkuForVehicle } from '../utils';
'''
if old1 in content:
    content = content.replace(old1, new1, 1)
    changes += 1
    print("1/2: import added")
else:
    print("FAILED 1/2")

old2 = '''const getPartLabel = (sku) => {
...
if old2 in content:
    ...
    changes += 1
    print("2/3: getPartLabel/getIcon inline defs removed")
else:
    print("FAILED 2/3")

old3 = '''const getSkuForVehicle = (v) => {
  if (!v) return null;
...
if old3 in content:
    ...
    changes += 1
    print("3/3: getSkuForVehicle inline def removed")
else:
    print("FAILED 3/3")
